...
public class DataManager : MonoBehaviour
{
    ...
    public void SavePlayData()
    {
        ...
        //#.Npc
        UnityEngine.GameObject[] npcObjects = UnityEngine.GameObject.FindGameObjectsWithTag("Npc");
        foreach (UnityEngine.GameObject npcObject in npcObjects)
        {
    ...
    public void LoadPlayData()
    {
        try
        {
            ...
            UnityEngine.GameObject p = UnityEngine.GameObject.FindWithTag("Player");
            ...
            {
                //ItemData itemData = GetItemDataByName(equipment.name);
