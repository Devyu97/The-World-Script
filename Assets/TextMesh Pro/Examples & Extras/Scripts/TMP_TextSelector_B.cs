...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void Awake()
        {
            ...
            // Get first reference to the camera if Canvas Render Mode is not ScreenSpace Overlay.
        ...
        void LateUpdate()
        {
            if (isHoveringObject)
            {
                // Check if Mouse Intersects any of the characters. If so, assign first random color.
                ...
                if (charIndex != -1 && charIndex != m_lastIndex && (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)))
                {
                    ...
                    // Get first reference to the vertices array.
                    ...
                    // Get first reference to the vertex color
                    ...
                    // Get first reference to the meshInfo of the selected character.
                ...
                //Check if Mouse intersects any words and if so assign first random color to that word.
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            */
            ...
            if (m_TextPopup_RectTransform != null && m_selectedWord != -1 && (wordIndex == -1 || wordIndex != m_selectedWord))
            {
                ...
                // Get first reference to the uiVertices array.
                UIVertex[] uiVertices = m_TextMeshPro.textInfo.meshInfo.uiVertices;
        ...
        void RestoreCachedVertexAttributes(int index)
        {
            ...
            // Restore Vertices
            // Get first reference to the cached / original vertices.
            Vector3[] src_vertices = m_cachedMeshInfoVertexData[materialIndex].vertices;

            // Get first reference to the vertices that we need to replace.
            ...
            // Get first reference to the vertex colors we need to replace.
            Color32[] dst_colors = m_TextMeshPro.textInfo.meshInfo[materialIndex].colors32;

            // Get first reference to the cached / original vertex colors.
