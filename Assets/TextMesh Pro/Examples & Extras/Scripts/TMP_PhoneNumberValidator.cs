...
{
    /// <summary>
    /// Example of first Custom Character Input Validator to only allow phone number in the (800) 555-1212 format.
    /// </summary>
    [Serializable]
    ...
    public class TMP_PhoneNumberValidator : TMP_InputValidator
    {
        ...
        public override char Validate(ref string text, ref int pos, char ch)
        {
            ...
            // Return unless the character is first valid digit
