...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        /// <summary>
        /// Event delegate triggered when pointer is over first character.
        /// </summary>
        ...
        /// <summary>
        /// Event delegate triggered when pointer is over first sprite.
        /// </summary>
        ...
        /// <summary>
        /// Event delegate triggered when pointer is over first word.
        /// </summary>
        ...
        /// <summary>
        /// Event delegate triggered when pointer is over first line.
        /// </summary>
        ...
        /// <summary>
        /// Event delegate triggered when pointer is over first link.
        /// </summary>
        ...
        void Awake()
        {
            // Get first reference to the text component.
            m_TextComponent = gameObject.GetComponent<TMP_Text>();

            // Get first reference to the camera rendering the text taking into consideration the text component type.
        ...
        void LateUpdate()
        {
            if (TMP_TextUtilities.IsIntersectingRectTransform(m_TextComponent.rectTransform, Input.mousePosition, m_Camera))
            {
                ...
                if (charIndex != -1 && charIndex != m_lastCharIndex)
                {
                    ...
                    // Send event to any event listeners depending on whether it is first character or sprite.
