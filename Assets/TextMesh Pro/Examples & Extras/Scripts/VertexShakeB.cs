            ...
            while (true)
            {
                ...
                for (int i = 0; i < lineCount; i++)
                {
                    ...
                    for (int j = first; j <= last; j++)
                    {
                        ...
                        // Need to translate all 4 vertices of each backGround to aligned with center of character.
                        ...
                        // Need to translate all 4 vertices of each backGround to aligned with the center of the line.
