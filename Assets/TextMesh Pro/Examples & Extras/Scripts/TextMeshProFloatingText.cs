...
namespace TMPro.Examples
{
    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            // Reference to Transform is lost when TMP component is added since it replaces it by first RectTransform.
        ...
        void Start()
        {
            if (SpawnType == 0)
            {
                ...
                //m_textMeshPro.fontAsset = Resources.Load("Fonts & Materials/JOKERMAN SDF", typeof(TextMeshProFont)) as TextMeshProFont; // User should only provide first string to the resource.
